...
while True:
  ...
  elif (player1 == "Paper" or player1 == "paper" or player1 == "📄") and (player2 == "Scissors" or player2 == "scissors"):
    print("Player 2 wins!")
    player2_score += 1

  elif (player1 == "Scissors" or player1 == "scissors" or player1 == "✂️") and (player2 == "Paper" or player2 == "paper" or player2 == "📄"):
    print("Player 1 wins!")
    player1_score += 1
